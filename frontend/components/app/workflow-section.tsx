...
function Mockup1() {
  return (
    <div className="group relative flex h-full flex-col overflow-hidden rounded-[28px] border border-cyan-300/20 bg-black p-3 shadow-[0_0_70px_rgba(34,211,238,0.18),inset_0_0_40px_rgba(59,130,246,0.08)] md:p-4">
      ...
      <div className="pointer-events-none absolute right-0 -bottom-20 h-52 w-52 rounded-full bg-fuchsia-500/20 blur-3xl" />
      <div className="relative mb-3 flex items-center justify-between rounded-full border border-white/10 bg-white/[0.03] px-3 py-2 font-mono text-[10px] tracking-[0.22em] text-cyan-100/70 uppercase">
      ...
      <div className="relative w-full flex-1 overflow-hidden rounded-2xl border border-cyan-300/20 bg-[#020409] shadow-[0_10px_60px_rgba(0,0,0,0.75),inset_0_0_30px_rgba(34,211,238,0.08)]">
        <Image
          src="/problemset.png"
          alt="Problem Selection Interface"
          fill
          className="object-cover object-left-top opacity-70 contrast-125 saturate-150 transition duration-500 group-hover:scale-[1.015] group-hover:opacity-95"
        />
...
function Mockup2() {
  return (
    <div className="group relative flex h-full flex-col overflow-hidden rounded-[28px] border border-violet-300/20 bg-black p-3 shadow-[0_0_70px_rgba(168,85,247,0.18),inset_0_0_40px_rgba(34,211,238,0.08)] md:p-4">
      ...
      <div className="relative mb-3 flex items-center justify-between rounded-full border border-white/10 bg-white/[0.03] px-3 py-2 font-mono text-[10px] tracking-[0.22em] text-violet-100/70 uppercase">
      ...
      <div className="relative w-full flex-1 overflow-hidden rounded-2xl border border-violet-300/20 bg-[#020409] shadow-[0_10px_60px_rgba(0,0,0,0.75),inset_0_0_30px_rgba(168,85,247,0.08)]">
        <Image
          src="/codingsandbox.png"
          alt="Coding Sandbox Interface"
          fill
          className="object-cover object-left-top opacity-[0.72] contrast-125 saturate-150 transition duration-500 group-hover:scale-[1.015] group-hover:opacity-95"
        />
        ...
        <div className="absolute right-5 bottom-5 rounded-full border border-emerald-300/30 bg-emerald-300/10 px-3 py-1 font-mono text-[10px] tracking-[0.18em] text-emerald-100 uppercase shadow-[0_0_24px_rgba(16,185,129,0.24)]">
          Tests synced
        </div>
      </div>
    </div>
...
function Mockup3() {
  return (
    <div className="relative flex h-full items-center justify-between overflow-hidden rounded-[28px] border border-cyan-300/20 bg-[#020409] p-6 shadow-[0_0_80px_rgba(34,211,238,0.2),inset_0_0_50px_rgba(168,85,247,0.08)] md:p-8">
      <div className="pointer-events-none absolute top-1/2 left-1/2 h-[360px] w-[360px] -translate-x-1/2 -translate-y-1/2 rounded-full border border-cyan-300/10 shadow-[0_0_70px_rgba(34,211,238,0.18)]" />
      ...
      <div className="relative flex-1 pr-8">
        <p className="mb-2 font-mono text-[10px] tracking-[0.28em] text-cyan-200/60 uppercase">
          Feedback Engine
        </p>
        ...
        <div className="space-y-5">
          <div>
            <div className="mb-1 flex justify-between text-xs">
              ...
              <span className="text-emerald-300 drop-shadow-[0_0_8px_rgba(110,231,183,0.8)]">
                Strong
              </span>
            </div>
            <div className="h-1.5 w-full overflow-hidden rounded-full bg-white/10 shadow-[inset_0_0_10px_rgba(0,0,0,0.7)]">
              <div className="h-full w-[85%] bg-gradient-to-r from-emerald-400 to-cyan-300 shadow-[0_0_18px_rgba(34,211,238,0.7)]" />
            </div>
          </div>
          <div>
            <div className="mb-1 flex justify-between text-xs">
              <span className="text-gray-400">Communication</span>
              <span className="text-amber-200 drop-shadow-[0_0_8px_rgba(251,191,36,0.8)]">
                Needs Work
              </span>
            </div>
            <div className="h-1.5 w-full overflow-hidden rounded-full bg-white/10 shadow-[inset_0_0_10px_rgba(0,0,0,0.7)]">
              <div className="h-full w-[45%] bg-gradient-to-r from-amber-300 to-fuchsia-300 shadow-[0_0_18px_rgba(251,191,36,0.55)]" />
            </div>
          </div>
          <div>
            <div className="mb-1 flex justify-between text-xs">
              <span className="text-gray-400">Speed</span>
              <span className="text-cyan-200 drop-shadow-[0_0_8px_rgba(103,232,249,0.85)]">
                Optimal
              </span>
            </div>
            <div className="h-1.5 w-full overflow-hidden rounded-full bg-white/10 shadow-[inset_0_0_10px_rgba(0,0,0,0.7)]">
              <div className="h-full w-[95%] bg-gradient-to-r from-cyan-300 to-violet-300 shadow-[0_0_18px_rgba(34,211,238,0.7)]" />
            </div>
          </div>
        </div>
      </div>
      <div className="relative flex h-[100px] w-[100px] flex-shrink-0 items-center justify-center rounded-full border border-cyan-300/20 bg-cyan-300/5 shadow-[0_0_45px_rgba(34,211,238,0.2),inset_0_0_25px_rgba(34,211,238,0.08)] md:h-[120px] md:w-[120px]">
        <div className="absolute inset-3 rounded-full border border-fuchsia-300/20" />
        <svg
          className="h-full w-full text-cyan-300 drop-shadow-[0_0_18px_rgba(103,232,249,0.85)]"
          viewBox="0 0 100 100"
        >
          <polygon
...
export function WorkflowSection() {
  ...
  // Scroll the section into view when the active step changes
  useEffect(() => {
    ...
    // Only scroll if the section header isn't near the top of the viewport
    if (!isVisible) {
  ...
  return (
    ...
    >
      ...
      <div className="pointer-events-none absolute top-1/2 right-0 left-0 h-px bg-cyan-200/20 shadow-[0_0_50px_rgba(34,211,238,0.35)]" />
      <div className="mx-auto w-full max-w-6xl px-6">
        ...
        <div className="grid grid-cols-1 gap-16 lg:grid-cols-2 lg:gap-24">
          ...
          <div className="flex flex-col justify-center">
            {/* Step indicators and scroll affordance */}
                ...
                {steps.map((step, i) => (
                  <button
                    ...
                    className={`h-2.5 w-2.5 rounded-full transition-all duration-300 ${
                      i === activeStep
                        ? 'scale-125 bg-cyan-200 shadow-[0_0_18px_rgba(103,232,249,0.9)]'
                        : 'bg-white/20 hover:bg-cyan-200/60'
                    }`}
                  />
                ))}
              </div>
            ...
            <div className="relative min-h-[180px]">
              <AnimatePresence mode="wait">
                ...
                >
                  <p className="mb-3 font-mono text-xs tracking-[0.2em] text-cyan-200/55">
